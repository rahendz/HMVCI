...
|
*/
$my_config['modules_locations'] = array ( MODULES_LOCATIONS );
...
|			$my_config['auth_override_class_method']['dashboard']['*'] = 'none|digest|basic';
|
| Here 'deals', 'accounts' and 'dashboard' are controller names, 'view', 'insert' and 'user' are methods within. An asterisk may also be used to specify an authentication method for an entire classes methods. Ex: $my_config['auth_override_class_method']['dashboard']['*'] = 'basic'; (NOTE: leave off the '_get' or '_post' from the end of the method name)
...
|
| Example: $my_config['rest_ip_whitelist'] = '123.456.789.0, 987.654.32.1';
|
...
|
| Example: $my_config['rest_ip_blacklist'] = '123.456.789.0, 987.654.32.1';
|
|
*/
...
|
*/
$my_config['rest_enable_keys'] = FALSE;
...
|
*/
$my_config['rest_key_name'] = 'X-API-KEY';
